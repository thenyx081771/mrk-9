...
Vue.api = Vue.prototype.$api = {
  ...
  saveMenu: "/broke-manager-service/menu/saveMenu", // 保存菜单
  deleteMenu: "/broke-manager-service/menu/deleteMenu", // 删除菜单
  ...
  queryMaxOtp: "/trade-service/document/queryMaxOtp", // 查询当前最大的otp号码
  ...
  queryPNDCalendarList: '/pnd-api/calendar/queryCalendarList',//查询日程管理列表
  deletePNDCalendarById: '/pnd-api/calendar/deleteCalendarById',//删除日程管理
